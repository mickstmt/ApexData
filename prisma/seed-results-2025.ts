/**
 * Seed Script: Race Results 2025
 *
 * Este script obtiene todos los resultados de carreras de la temporada 2025
 * desde la API de Jolpica F1 y los inserta en nuestra base de datos.
 *
 * Uso: npx tsx prisma/seed-results-2025.ts
 */
...
async function seedResults2025() {
  console.log('🚀 Iniciando seed de resultados 2025...\n');

  try {
    // 1. Obtener todas las carreras con resultados de 2025
    const races = await fetchRacesWithResults(2025);
