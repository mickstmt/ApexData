/**
 * Seed Script: Race Results 2023
 *
 * Este script obtiene todos los resultados de carreras de la temporada 2023
 * desde la API de Jolpica F1 y los inserta en nuestra base de datos.
 *
 * Uso: npx tsx prisma/seed-results-2023.ts
 */
...
async function fetchRacesWithResults(year: number) {
  ...
  // Intentar obtener cada ronda individualmente (hasta la ronda 22)
  // La temporada 2023 tuvo 22 carreras
...
async function seedResults2023() {
  console.log('🚀 Iniciando seed de resultados 2023...\n');

  try {
    // 1. Obtener todas las carreras con resultados de 2023
    const races = await fetchRacesWithResults(2023);
