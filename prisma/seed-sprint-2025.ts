...
async function seedSprint2025() {
  console.log('🚀 Iniciando seed de sprint races 2025...\n');

  try {
    // 1. Obtener todas las carreras con sprint de 2025
    const races = await fetchSprintRaces(2025);

    if (races.length === 0) {
      console.log('⚠️  No se encontraron carreras sprint para 2025');
      return;
    }
    ...
    console.log('\n' + '='.repeat(60));
    console.log('✨ Seed de sprint races 2025 completado exitosamente!');
