...
async function seedQualifying2024() {
  console.log('🚀 Iniciando seed de qualifying 2024...\n');

  try {
    // 1. Get all races with qualifying from 2024
    const races = await fetchQualifyingResults(2024);

    if (races.length === 0) {
      console.log('⚠️  No se encontraron resultados de qualifying para 2024');
      return;
    }
    ...
    console.log('\n' + '='.repeat(60));
    console.log('✨ Seed de qualifying 2024 completado exitosamente!');
