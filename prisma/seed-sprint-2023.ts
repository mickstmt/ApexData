...
async function seedSprint2023() {
  console.log('🚀 Iniciando seed de sprint races 2023...\n');

  try {
    // 1. Obtener todas las carreras con sprint de 2023
    const races = await fetchSprintRaces(2023);

    if (races.length === 0) {
      console.log('⚠️  No se encontraron carreras sprint para 2023');
      return;
    }
    ...
    console.log('\n' + '='.repeat(60));
    console.log('✨ Seed de sprint races 2023 completado exitosamente!');
