...
async function seedQualifying2023() {
  console.log('🚀 Iniciando seed de qualifying 2023...\n');

  try {
    // 1. Get all races with qualifying from 2023
    const races = await fetchQualifyingResults(2023);

    if (races.length === 0) {
      console.log('⚠️  No se encontraron resultados de qualifying para 2023');
      return;
    }
    ...
    console.log('\n' + '='.repeat(60));
    console.log('✨ Seed de qualifying 2023 completado exitosamente!');
