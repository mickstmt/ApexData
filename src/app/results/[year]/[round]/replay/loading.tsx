...
export default function ReplayLoading() {
  return (
    <div className="bg-[var(--replay-fondo)] text-[var(--replay-texto)] md:grid md:h-[calc(100dvh-4rem)] md:grid-cols-[1fr_340px] md:grid-rows-[auto_1fr_auto]">
      <span role="status" className="sr-only">
        Cargando el replay…
      </span>

      <div className="md:col-span-2">
        <div className="flex items-end justify-between border-b border-[var(--replay-borde)] px-4 py-3">
          <div>
      ...
      <div className="md:col-start-2 md:row-span-2 md:row-start-2 md:border-l md:border-[var(--replay-borde)]">
